...
# io.dropwizard:dropwizard-auth:jar:1.0.2
# com.datastax.cassandra:cassandra-driver-extras:jar:3.1.1
...
java_library(
    ...
    exports = [
        ...
        "@ch_qos_logback_logback_access//jar",
        ...
        "@io_dropwizard_dropwizard_request_logging//jar",
...
java_library(
    ...
    visibility = ["//visibility:public"],
    exports = [
        "@com_datastax_cassandra_cassandra_driver_extras//jar",
        "@com_datastax_cassandra_cassandra_driver_core//jar",
        "@com_github_jnr_jffi//jar",
        "@com_github_jnr_jnr_constants//jar",
        "@com_github_jnr_jnr_ffi//jar",
